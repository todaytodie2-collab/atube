...
console.log('🚀 =================================================================');
console.log('🌟 TMDB REAL AUTHENTIC CATALOG INGESTION & COMPILATION ENGINE');
console.log('   - 1,000 Real Foreign Blockbusters (English Titles & Matching Posters)');
console.log('   - 1,000 Real Arabic Movies (Arabic Titles & Matching Posters)');
console.log('   - 1,000 Real Anime Series & Works (Original Anime Titles & Posters)');
console.log('   - 300 Real Arabic Series 2014-2024 (Arabic Titles & Posters)');
console.log('   - 141 Verified Live Channels (Isolated with Authentic Logos)');
console.log('=================================================================\n');
...
const GENRE_MAP = {
  ...
  10759: 'أكشن ومغامرات', 10762: 'أطفال', 10763: 'أخبار', 10764: 'واقعي',
  10765: 'خيال وفانتازيا', 10766: 'مسلسلات درامية', 10767: 'حوار', 10768: 'حرب وسياسة'
};
...
function generateServerSuite(tmdbId, title, isSeries = false, season = 1, episode = 1) {
  ...
  if (isSeries) {
    return [
      {
        name: 'سيرفر AutoEmbed VIP (سحابي سريع • متعدد الجودات)',
        url: `https://player.autoembed.cc/embed/tv/${targetId}/${season}/${episode}`,
        stream_url: `https://player.autoembed.cc/embed/tv/${targetId}/${season}/${episode}`,
        quality: '1080p FHD',
        badge: 'سحابي VIP ⚡',
        isEmbed: true,
        seek15mUrl: `https://player.autoembed.cc/embed/tv/${targetId}/${season}/${episode}#t=900`
      },
      {
        ...
        badge: 'VIP Fast ⚡',
        isEmbed: true,
        seek15mUrl: `https://vidlink.pro/tv/${targetId}/${season}/${episode}?primaryColor=00e5ff&secondaryColor=ff0055&startAt=900`
      },
      {
        name: 'سيرفر VidSrc Direct (سريع ومترجم)',
        url: `https://vidsrc.xyz/embed/tv/${targetId}/${season}/${episode}`,
        stream_url: `https://vidsrc.xyz/embed/tv/${targetId}/${season}/${episode}`,
        quality: '1080p HD',
        badge: 'سيرفر سحابي 🌟',
        isEmbed: true,
        seek15mUrl: `https://vidsrc.xyz/embed/tv/${targetId}/${season}/${episode}#t=900`
      },
      {
        name: 'سيرفر SmashyStream (عالي السرعة FHD)',
        url: `https://embed.smashystream.com/playere.php?tmdb=${targetId}&season=${season}&episode=${episode}`,
        stream_url: `https://embed.smashystream.com/playere.php?tmdb=${targetId}&season=${season}&episode=${episode}`,
        quality: '1080p FHD',
        badge: 'سيرفر VIP 🚀',
        isEmbed: true,
        seek15mUrl: `https://embed.smashystream.com/playere.php?tmdb=${targetId}&season=${season}&episode=${episode}&start=900`
      },
      {
        ...
        badge: 'سيرفر بديل 🌟',
        isEmbed: true,
        seek15mUrl: `https://multiembed.mov/?video_id=${targetId}&tmdb=1&s=${season}&e=${episode}&start=900`
      },
      {
        ...
        badge: 'سيرفر 2Embed 🚀',
        isEmbed: true,
        seek15mUrl: `https://www.2embed.cc/embedtv/${targetId}&s=${season}&e=${episode}#t=900`
      },
      {
        name: 'سيرفر MoviesAPI Club (سيرفر مباشر)',
        url: `https://moviesapi.club/tv/${targetId}-${season}-${episode}`,
        stream_url: `https://moviesapi.club/tv/${targetId}-${season}-${episode}`,
        quality: '720p HD',
        badge: 'سحابي مباشر',
        isEmbed: true,
        seek15mUrl: `https://moviesapi.club/tv/${targetId}-${season}-${episode}#t=900`
      }
    ];
  } else {
    return [
      {
        ...
        stream_url: `https://player.autoembed.cc/embed/movie/${targetId}`,
        quality: '1080p FHD',
        badge: 'سحابي VIP ⚡',
        isEmbed: true,
        seek15mUrl: `https://player.autoembed.cc/embed/movie/${targetId}#t=900`
      },
      {
        name: 'سيرفر VidLink Ultra (سحابي FHD • مترجم)',
        ...
        badge: 'VIP Fast ⚡',
        isEmbed: true,
        seek15mUrl: `https://vidlink.pro/movie/${targetId}?primaryColor=00e5ff&secondaryColor=ff0055&startAt=900`
      },
      {
        name: 'سيرفر VidSrc Direct (سريع ومترجم)',
        url: `https://vidsrc.xyz/embed/movie/${targetId}`,
        stream_url: `https://vidsrc.xyz/embed/movie/${targetId}`,
        quality: '1080p HD',
        badge: 'سيرفر سحابي 🌟',
        isEmbed: true,
        seek15mUrl: `https://vidsrc.xyz/embed/movie/${targetId}#t=900`
      },
      {
        name: 'سيرفر SmashyStream (عالي السرعة FHD)',
        url: `https://embed.smashystream.com/playere.php?tmdb=${targetId}`,
        stream_url: `https://embed.smashystream.com/playere.php?tmdb=${targetId}`,
        quality: '1080p FHD',
        badge: 'سيرفر VIP 🚀',
        isEmbed: true,
        seek15mUrl: `https://embed.smashystream.com/playere.php?tmdb=${targetId}&start=900`
      },
      {
        name: 'سيرفر MultiEmbed (متعدد الجودات • مدبلج/مترجم)',
        ...
        badge: 'سيرفر بديل 🌟',
        isEmbed: true,
        seek15mUrl: `https://multiembed.mov/?video_id=${targetId}&tmdb=1&start=900`
      },
      {
        name: 'سيرفر 2Embed Cinema (فائق السرعة)',
        ...
        badge: 'سيرفر 2Embed 🚀',
        isEmbed: true,
        seek15mUrl: `https://www.2embed.cc/embed/${targetId}#t=900`
      },
      {
        name: 'سيرفر MoviesAPI Club (سيرفر مباشر)',
        url: `https://moviesapi.club/movie/${targetId}`,
        stream_url: `https://moviesapi.club/movie/${targetId}`,
        quality: '720p HD',
        badge: 'سحابي مباشر',
        isEmbed: true,
        seek15mUrl: `https://moviesapi.club/movie/${targetId}#t=900`
      }
    ];
  }
}
...
async function run() {
  // =========================================================================
  // 1. Fetch 1,000 Real Foreign Blockbuster Movies
  // =========================================================================
  console.log('📡 Fetching 1,000 Real Foreign Blockbuster Movies from TMDB...');
  const foreignMovies = [];
    ...
    try {
      ...
      for (const m of data.results) {
        ...
        foreignMovies.push({
          id: `movie_${m.id}`,
          tmdb_id: m.id,
          title: m.title, // PURE ENGLISH TITLE FOR FOREIGN MOVIES
          arabic_title: null, // Strictly null so English title renders in card & UI
          content_type: 'movie',
          category: 'الأفلام',
          ...
          servers: generateServerSuite(m.id, m.title, false)
        });
  ...
  console.log(`✅ Loaded ${foreignMovies.length} Real Foreign Movies.`);

  // =========================================================================
  // 2. Fetch 1,000 Real Arabic Movies
  // =========================================================================
  console.log('\n📡 Fetching 1,000 Real Arabic Movies from TMDB...');
  const arabicMovies = [];
  ...
  // Continue fetching Arabic discover pages until reaching 1000
  ...
  console.log(`✅ Loaded ${arabicMovies.length} Real Arabic Movies.`);

  // =========================================================================
  // 3. Fetch 1,000 Real Anime Series & Works
  // =========================================================================
  console.log('\n📡 Fetching 1,000 Real Anime Series & Works from TMDB...');
  const animeList = [];
      ...
      for (const item of data.results) {
        ...
        for (let ep = 1; ep <= numEpisodes; ep++) {
          episodes.push({
            ...
            duration: '24 دقيقة',
            thumbnail: poster,
            servers: generateServerSuite(item.id, item.name, true, 1, ep)
          });
        }
        ...
        animeList.push({
          id: `anime_${item.id}`,
          tmdb_id: item.id,
          title: item.name, // AUTHENTIC REAL ANIME NAME (e.g. Solo Leveling, Jujutsu Kaisen)
          arabic_title: null, // Keep clean English name for international anime
          content_type: 'series',
          category: 'الأنمي',
          ...
          servers: generateServerSuite(item.id, item.name, true, 1, 1)
        });

        if (animeList.length >= 1000) break;
      }
    } catch (e) {
      console.warn(`Anime page ${page} error:`, e.message);
    }
  }
  console.log(`✅ Loaded ${animeList.length} Real Anime Series & Works.`);

  // =========================================================================
  // 4. Fetch 300 Real Arabic TV Series (2014-2024)
  // =========================================================================
  console.log('\n📡 Fetching 300 Real Arabic TV Series (2014-2024) from TMDB...');
  const arabicSeries = [];
  ...
  const seriesQueries = [
    ...
    'رحيم', 'قابيل', 'زي الشمس', 'شاهد عيان', 'النمر', 'ضل راجل', 'موسى', 'لعبة نيوتن',
    'نجيب زاهي زركش', 'خلي بالك من زيزي', 'راجعين يا هوى', 'فاتن أمل حربي', 'المشوار', 'سوتس بالعربي',
    'مكتوب عليا', 'أحلام سعيدة', 'تغيير جو', 'تحت الوصاية', 'رسالة الإمام', 'الصفارة', 'جت سليمة'
  ];
        ...
        for (const s of data.results) {
          ...
          for (let ep = 1; ep <= numEpisodes; ep++) {
            episodes.push({
              ...
              duration: '45 دقيقة',
              thumbnail: poster,
              servers: generateServerSuite(s.id, s.name, true, 1, ep)
            });
          }
          ...
          arabicSeries.push({
            ...
            servers: generateServerSuite(s.id, s.name, true, 1, 1)
          });
  ...
  // Continue with Arabic discover pages
  ...
  console.log(`✅ Loaded ${arabicSeries.length} Real Arabic TV Series.`);

  // =========================================================================
  // 5. Load 141 Live Channels
  // =========================================================================
  console.log('\n📡 Loading 141 Live TV Channels...');
  ...
  try {
    ...
    console.warn('Channels error:', e.message);
  }
  ...
  const liveChannelsCatalog = fullLiveChannels.map(ch => ({
    ...
    content_type: 'channel', // STRICTLY CHANNEL
  ...
  console.log('=================================================================');
  console.log(`✅ Total Master Real Works:       ${masterCatalog.length}`);
  ...
  const outputCode = '/* Auto-generated Ultra Massive Catalog with 100% Real TMDB Works & Authentic Posters */\nwindow.BUNDLED_CATALOG = ' + JSON.stringify(masterCatalog) + ';\nwindow.ATUBE_STATIC_CHANNELS = ' + JSON.stringify(fullLiveChannels) + ';\n';
  fs.writeFileSync(bundledPath, outputCode, 'utf8');

  console.log('💾 Successfully saved 100% authentic real catalog into js/bundled-data.js');
}
